...
ご夫婦と新社長（将来の代表取締役）のそれぞれの在留ステータスと役割の設計です。
...
graph TD
    ...
    subgraph 新社長/継承役員候補 (日本常駐基本)
        F[新社長: 日本居住者] --> G[日本国内で常駐指揮/代表権継承]
        G --> H[PE恒久的施設リスクの回避実態]
...
※ **新社長（従業員）の日本常駐前提について**: 
本計画では、代表権を継承する新社長（従業員）は日本国内に常駐し、実務および代表権の行使を行います。これにより、オーナー夫婦が日本非居住者となった後も、日本法人の管理支配地が日本国内にあることを税務上明確にし、PE（恒久的施設）認定リスクを極小化します。将来、本人がダナン等への移住・勤務を希望した場合のみ、オプションとしてベトナムでの就労ビザ取得手続き等を実施します（計算上は日本常駐のまま据え置きます）。
...
gantt
    ...
    新社長の就任・国内常駐体制への移行 : 2027-12, 2028-03
```

> [!NOTE]
> **※ 新社長（従業員）が将来的にベトナム移住・現地勤務を希望した場合の手続きとシミュレーション**
> 後継者（新社長）が将来的にベトナム（ダナン）での勤務および現地移住を希望した場合は、希望された時点で以下の手続きを行い、在留・就労スキームを再設計します。
> 
> **■ 実施手続き・ビザ要件**
> 1. **雇用契約の締結**: ベトナム法人と新社長との間で、正式な雇用契約を現地基準（職種: Manager等）で締結します。
...
> 4. **代替PE対策の策定**: 代表取締役の日本不在に伴い、日本法人の契約行為決定プロセス等をどう国内に維持するかを再設計します。
> 
> **■ 移住希望時のシミュレーション（年額）**
> *   **ベトナム社会保険料発生の理由**: オーナー夫婦（夫）は配偶者TRCのため加入不要ですが、後継者は「100%支配ガバナンス維持（出資させない）」を最優先にして雇用契約＋労働許可証（WP）で就労させるため、ベトナム社会保険法の規定により加入義務が発生します（支配権維持のための必要安全コストです）。
*   **【会社側負担（ベトナム現地法人コスト）】**:
>     *   基本給与：年270万円（月額22.5万円 / 約4,500万VND）
>     *   公的社会保険料（会社負担分）：年約55万円（月額約774万VND）
>     *   コンドミニアム（社宅家賃）：年約120万円（月額10万円相当）
>     *   就労ビザ・労働許可証（WP）申請＆維持費：年約15万円
>     *   *合計：年約460万円（月約38.3万円）*
> *   **【本人受給分（手取り・自己負担内訳）】**:
>     *   額面給与：年270万円（月額22.5万円 / 約4,500万VND）
>     *   公的社会保険料（個人負担分）：年約24万円（月約340万VND）
>     *   個人所得税（PIT・概算）：年約22万円（月約300万VND）
>     *   福利厚生：コンドミニアム（社宅）の無償提供
>     *   *実質手取り額：年約224万円（月約18.7万円 / 約3,860万VND）*
