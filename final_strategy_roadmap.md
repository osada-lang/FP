...
> [!NOTE]
> **※ 新社長（従業員）が将来的にベトナム移住・現地勤務を希望した場合の手続き**
> 後継者（新社長）が将来的にベトナム（ダナン）での勤務および現地移住を希望した場合は、希望された時点で以下の手続きを行い、在留・就労スキームを再設計します（計算はその際に再度実施します）。
> 1. **雇用契約の締結**: ベトナム法人と新社長との間で、正式な雇用契約を現地基準（職種: Manager等）で締結します。
> 2. **外国人労働許可証（Work Permit）の取得**: 3年以上の専門職（経営・管理・専門家）の職歴証明書、および大学の卒業証明書（専攻分野と現地職務の整合性が必要）に対し、日本国内での公証・外務省公印確認・ベトナム大使館領事認証を完了させ、現地労働局へ申請します。
> 3. **労働TRC（一時滞在カード）の取得**: 労働許可証の発行後、最長2年有効な就労用TRC（一時滞在カード）を申請・取得します。
> 4. **代替PE対策の策定**: 新社長が日本国内を長期不在にする（非居住者化する）ため、日本法人の実態や契約行為の決定プロセスをどう国内に維持するか（他の日本常駐スタッフへの権限移譲、あるいは代理人の選任等）を再設計し、税務上のPE認定リスクを防ぎます。
